...
"""
my_list = [10, 3, 8, 9, 42, "hello" , [5, 4, 3, "world"]]
print(my_list)
...
"""
my_dict = {'key1': 'value1', 'key2': 'value2'}
dictData = {"name": "python", "number" :23564897}
...
"""
my_dict = ('keyl': 'valuel', 'key2': 'value2')
...
"""
my_dict = {'keys': 'valuel', 'key2': 'value2'}

my_dict .update ({"keyl" : "V4"})
